    ...
    <div id="main-content" class="container allContent-section py-4">
        <div class="row">
            ...
            <div class="card">
                    ...
                    <h4 style="color:white;">Total Pet</h4>
                    <h5 style="color:white;">
                    <?php
        ...
        <?php
            ...
            }else if (isset($_GET['pet']) && $_GET['pet'] == "error") {
                echo '<script> alert("Adding Unsuccess")</script>';
            }
            if (isset($_GET['customer']) && $_GET['customer'] == "success") {
                echo '<script> alert("customer Successfully Added")</script>';
            }else if (isset($_GET['customer']) && $_GET['customer'] == "error") {
                echo '<script> alert("Adding Unsuccess")</script>';
            }
            if (isset($_GET['doctor']) && $_GET['doctor'] == "success") {
                echo '<script> alert("doctor Successfully Added")</script>';
            }else if (isset($_GET['doctor']) && $_GET['doctor'] == "error") {
                echo '<script> alert("Adding Unsuccess")</script>';
            }
        ?>
